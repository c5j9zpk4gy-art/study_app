...
CURRICULUM_DB = {
    ...
    "공통수학2": [
        "1. 도형의 방정식 (평면좌표, 직무의 방정식, 원의 방정식, 도형의 이동)",
...
def render_result():
    ...
    # 최상위 학군지일수록 요구되는 문제집 Level이 비약적으로 증가함
